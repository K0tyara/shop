...
<body class="font-sans antialiased min-h-screen" style="margin: 0">
<div class="antialiased bg-gray-50 dark:bg-gray-900">
            ...
            <div class="flex justify-start items-center">
                ...
                <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                    <img
                        ...
                        alt="Flowbite Logo"
                    />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Shop Admin</span>
                </a>
            </div>
    ...
    >
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <x-admin.menu.left.button :href="route('admin.product.index')"
                                              :name="'Products'"
                                              :icon="'fa-regular fa-gem fa-lg'"/>
                </li>
                <li>
                    <x-admin.menu.left.button :href="route('admin.category.index')"
                                              :name="'Categories'"
                                              :icon="'fa-solid fa-tag fa-lg'"/>
                </li>
                <li>
                    <x-admin.menu.left.button :href="route('admin.subcategory.index')"
                                              :name="'Subcategories'"
                ...
                <li>
                    <x-admin.menu.left.button :href="route('admin.color.index')"
                                              :name="'Colors'"
    ...
    <main class="p-4 md:ml-64 h-auto pt-20" style="height: 100%">
        ...
        @if($errors->any())
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                <strong class="font-bold">Ой! Виникли деякі проблеми.</strong>
                <ul>
